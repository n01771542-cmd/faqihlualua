...
-- TODO: Sambungkan ke private endpoint/server Anda setelah siap.
...
-- [ DATA NEW SCRIPTS (18 NEW SCRIPTS) ]
local NewScriptsData = {
    { name = "VOIDHUB", status = "No Key", recommended = false, url = 'loadstring(game:HttpGet("https://voidon.top/api/loader/main"))()' },
    { name = "LIMBO HUB", status = "No Key", recommended = false, url = 'loadstring(game:HttpGet("https://limbohub.my.id/loader.lua"))()' },
    { name = "OXIDE HUB", status = "No Key", recommended = false, url = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/xulfo/Oxide-Loader/main/Main.lua"))()' },
    { name = "PULSE HUB", status = "No Key", recommended = false, url = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/PulseZax/Loader/refs/heads/main/.lua"))()' },
    { name = "YARHM HUB", status = "No Key", recommended = false, url = 'loadstring(game:HttpGet("https://yarhm.com"))()' },
    { name = "RIFT GOHA", status = "Key", recommended = false, url = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/Dodoyung24/script-core/main/Steal-An-Egg"))()' },
    { name = "ATHERHUB", status = "Key", recommended = false, url = 'loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/2529a5f9dfddd5523ca4e22f21cceffa.lua"))()' },
    { name = "VANITY HUB", status = "Key", recommended = false, url = 'loadstring(game:HttpGet("https://vanityscript.xyz/loader"))()' },
    { name = "RONIX HUB", status = "Key", recommended = false, url = 'loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/fda9babd071d6b536a745774b6bc681c.lua"))()' },
    { name = "MONARCHH", status = "No Key", recommended = false, url = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/nobuxy/monarch.win/refs/heads/main/Monarch.lua"))()' },
    { name = "UNREXL", status = "Key", recommended = false, url = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/unrexl/Scripts/refs/heads/main/StealaEgg"))()' },
    { name = "WADIDIS HUB", status = "Key", recommended = false, url = 'loadstring(game:HttpGet("https://api.jnkie.com/api/v1/luascripts/public/809c81e15814d1c016f44d9fe56587f5f38c55a97f203f11bc1a3f7cc3725c5f/download"))()' },
    { name = "H4XSCRIPTS", status = "Key", recommended = false, url = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/H4xScripts/Loader/refs/heads/main/loader.lua", true))()' },
    { name = "RBX LIFE / DIVINE EGG", status = "No Key", recommended = false, url = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/SynergyNetworkz/VULN/refs/heads/main/STEALANEGG.lua"))()' },
    { name = "THAN HUB", status = "Key", recommended = false, url = 'loadstring(game:HttpGet("https://api.luarmor.net/files/v4/loaders/d1c82862a093e64c6bd82bb6d6f7a46b.lua"))()' },
    { name = "TOKINU", status = "No Key", recommended = false, url = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/Tokinu-Scripts/Steal-An-Egg/refs/heads/main/Instant/Tp"))()' },
    { name = "NEVA HUB", status = "No Key", recommended = false, url = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/VEZ2/NEVAHUB/main/2"))()' },
    { name = "LEVON HUB", status = "No Key", recommended = false, url = "loadstring(game:HttpGet('https://pastefy.app/nasHhfko/raw'))()" }
}
